...
const useStyles = makeStyles((theme) => ({
  ...
  featureItems: {
    ...
    height: "100%",
    background:
      "url(https://cdn.watheia.org/assets/illustrations/bg-shapes.svg) no-repeat top center",
  ...
  iconCover: {
    ...
    height: 60,
    background:
      "url(https://cdn.watheia.org/assets/illustrations/bgicon.svg) no-repeat center center",
    backgroundSize: "contain",
    display: "flex",
