...
const Placements = ({ className, ...rest }: ViewComponentProps): JSX.Element => {
      ...
      <Grid container spacing={1} data-aos="fade-up">
            ...
            title={
              <span>
                <Typography component="span" variant="inherit" color="primary">
                  Watheia Labs is the leading job placement site
                </Typography>{" "}
        ...
        <Grid item xs={12}>
          <div className={classes.placementGrid}>
            <div>
              <CountUpNumber end={112} suffix="K" label="Placement" textColor="primary" />
            </div>
            <div className={classes.placementGridItemMiddle}>
              <CountUpNumber end={120} suffix="K" label="Positions" textColor="primary" />
            </div>
            <div>
              <CountUpNumber end={168} suffix="K" label="Partners" textColor="primary" />
            </div>
          </div>
        </Grid>
      </Grid>
