  ...
  return (
    <div className={className} {...rest}>
      <Grid container spacing={4}>
        ...
        >
          <Image
            src="https://cdn.watheia.org/assets/illustrations/dashboard-screenshot1.jpg"
            alt="..."
          ...
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <SectionHeader
                ...
                subtitle="Watheia Labs styles and extends Material-UI components, but also included brand new landing page focused components."
                align="left"
                fadeUp
                disableGutter
                titleVariant="h3"
            ...
            <Grid item xs={12}>
              <div className={classes.placementGrid}>
                ...
                <div>
                  <CountUpNumber end={5.0} label="Review Score" textColor="primary" />
                </div>
              </div>
            </Grid>
          </Grid>
