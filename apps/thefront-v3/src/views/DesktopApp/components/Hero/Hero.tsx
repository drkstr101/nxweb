      ...
      >
        <Grid item container alignItems="center" xs={12} md={6} data-aos={"fade-up"}>
          <SectionHeader
            ...
            subtitle="World developers use our Watheia theme to build their internal tools and client admin applications. Save yourself time and money."
            ctaGroup={[
        ...
        >
          <Image
            src="https://cdn.watheia.org/assets/illustrations/dashboard-screenshot.jpg"
