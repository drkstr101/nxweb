          ...
          <Grid container justify="space-between" spacing={isMd ? 4 : 2}>
            <Grid item xs={12} md={6} data-aos={"fade-right"}>
              <SectionHeader
                ...
                subtitle="Watheia is a simple, modular and accessible component library that gives you the building blocks you need to build your React applications."
          ...
          >
              ...
              <Grid container alignItems="center" spacing={2}>
                <Grid item xs={12} md={6}>
                  ...
                  <Typography color="textPrimary" variant="body1">
                    300 + component compositions, which will help you to build any page
                    easily.
                  </Typography>
                </Grid>
                <Grid item xs={12} md={6}>
                  ...
                  <Typography color="textPrimary" variant="body1">
                    30 + stand-alone, fully customizable components designed by following
            ...
            <Grid item xs={12} md={6} data-aos={"fade-left"}>
              <SectionHeader
                ...
                subtitle="Whether you're creating a subscription service, an on-demand marketplace, an e-commerce store, or a portfolio showcase, Watheia helps you create the best possible product for your users."
                align="left"
                disableGutter
                titleVariant="h3"
                titleProps={{ className: classes.fontWeight900 }}
