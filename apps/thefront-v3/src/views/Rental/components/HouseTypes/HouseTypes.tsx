...
const HouseTypes = ({ className, ...rest }: ViewComponentProps): JSX.Element => {
        ...
        <Grid item xs={12} sm={4} data-aos="fade-up">
          <CardBase withShadow liftUp className={classes.cardBase}>
            <>
              <div>
                <NoSsr>
                  <i className={clsx(classes.icon, "fas fa-door-open", "card-icon")} />
                </NoSsr>
              </div>
              <Typography
                variant="h5"
        ...
        <Grid item xs={12} sm={4} data-aos="fade-up">
          <CardBase withShadow liftUp className={classes.cardBase}>
            <>
              <div>
                <NoSsr>
                  <i className={clsx(classes.icon, "fas fa-box-tissue", "card-icon")} />
                </NoSsr>
              </div>
              <Typography
                variant="h5"
