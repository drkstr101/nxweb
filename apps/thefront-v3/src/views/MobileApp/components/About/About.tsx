...
import { useMediaQuery, Grid, colors, Typography, Divider } from "@material-ui/core"
import Image from "@watheia/atoms.image"
import { SectionHeader } from "@watheia/front.molecules"
import { HeroShaped, Section, CardBase } from "@watheia/front.organisms"
    ...
    <div className={className} {...rest}>
      <HeroShaped
        leftSide={
          <SectionHeader
            ...
            ctaGroup={[
              <Image
                src="https://cdn.watheia.org/assets/mobile-addons/app-store.png"
                alt="Get in on App Store"
                className={classes.appStore}
                lazy={false}
              />,
              <Image
                src="https://cdn.watheia.org/assets/mobile-addons/play-store.png"
      ...
      <Section narrow>
        <Grid container spacing={isMd ? 4 : 2}>
          <Grid item xs={12} sm={6} data-aos="fade-up">
            <Grid container alignItems="flex-start" justify="center">
              <CardBase className={classes.cardBase} withShadow liftUp>
                <>
                  <Image
                    src="https://cdn.watheia.org/assets/illustrations/travelers.svg"
                    alt="..."
                    lazy={false}
                  />
          ...
          <Grid item container alignItems="center" xs={12} sm={6} data-aos="fade-up">
            <SectionHeader
              title={
                <span>
                  <Typography color="secondary" variant="inherit" component="span">
