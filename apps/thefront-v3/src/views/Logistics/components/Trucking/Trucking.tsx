...
const useStyles = makeStyles((theme) => ({
  ...
  cover: {
    ...
    background:
      "url(https://cdn.watheia.org/assets/illustrations/patterns-bg.svg) no-repeat left bottom",
...
const Trucking = ({ data, className, ...rest }: ViewComponentProps): JSX.Element => {
      ...
      <HeroShaped
        ...
        rightSide={
          <div className={classes.cover}>
            <Image
              src="https://cdn.watheia.org/assets/illustrations/macbook-dashboard.png"
