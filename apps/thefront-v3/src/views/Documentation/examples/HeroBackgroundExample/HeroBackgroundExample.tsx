        ...
        <Grid container spacing={4}>
          <Grid item xs={12}>
            <Typography variant="h3" style={{ color: 'white', fontWeight: 900, }}>
                Join the world's leading companies at Watheia Labs 2020
            </Typography>
          </Grid>
          <Grid item xs={12} md={6}>
            <Typography variant="h5" style={{ color: 'white' }} gutterBottom>
                Whether it’s Porsche, Stripe, Intercom, Amazon, or Google, something about Watheia Labs works for our global partners.
            </Typography>
            <Typography variant="h5" style={{ color: 'white' }}>
                Want more information? Download our overview and a member of our specialist team will be in touch to talk about your goals for Watheia Labs 2020.
            </Typography>
          </Grid>
          <Grid item xs={12} md={6}>
...
export default function Example() {
  return (
    <Box marginBottom={2} padding={2} border="1px solid #ccc" borderRadius="4px">
      <HeroBackground backgroundImg="https://cdn.watheia.org/assets/photos/expo-gallery/gallery3.jpg">
        <Grid container spacing={4}>
          <Grid item xs={12}>
            <Typography variant="h3" style={{ color: 'white', fontWeight: 900, }}>
              Join the world's leading companies at Watheia Labs 2020
            ...
            <Grid container spacing={4}>
              ...
              <Grid item xs={12} md={6}>
                <Typography variant="h5" style={{ color: "white" }} gutterBottom>
                  ...
                  Watheia Labs works for our global partners.
                </Typography>
                <Typography variant="h5" style={{ color: "white" }}>
                  Want more information? Download our overview and a member of our
                  specialist team will be in touch to talk about your goals for Watheia Labs
                  2020.
                </Typography>
              </Grid>
              <Grid item xs={12} md={6}>
