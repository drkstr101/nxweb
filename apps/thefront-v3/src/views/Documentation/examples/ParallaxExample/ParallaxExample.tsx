          ...
          <CardBase withShadow style={{ width: 500, height: 'auto', background: 'transparent' }}>
            <SectionHeader
              ...
              subtitle={<span style={{ color: 'white' }}>
                Watheia Labs styles and extends Material UI components, but also included brand new landing page focused components.
              </span>}
            />
          </CardBase>
        </div>
            ...
            >
              ...
              >
                <SectionHeader
                  ...
                  subtitle={
                    <span style={{ color: "white" }}>
                      Watheia Labs styles and extends Material UI components, but also
