  ...
  return (
    <Box marginBottom={2} padding={2} border="1px solid #ccc" borderRadius="4px">
      <CardReview
        ...
        authorPhoto={{ src: 'https://cdn.watheia.org/assets/photos/people/veronica-adams.jpg', srcSet: 'https://cdn.watheia.org/assets/photos/people/veronica-adams@2x.jpg 2x' }}
      />
    </Box>
  );
}
