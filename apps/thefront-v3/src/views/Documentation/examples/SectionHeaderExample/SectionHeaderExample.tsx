...
export default function Example() {
  return (
    <Box marginBottom={2} display="flex" justifyContent="space-evenly" alignItems="center" padding={2} border="1px solid #ccc" borderRadius="4px">
      <SectionHeader
        title={<>Find a job you love.<a href="https://thefront-v3.watheia.app/"> Learn more</a></>}
        subtitle={<>Try it now.<a href="https://thefront-v3.watheia.app/"> Learn more</a></>}
        ctaGroup={[(
            <Button color="primary" variant="contained">Submit</Button>
        ), (
            <Button color="primary" variant="outlined">Learn More</Button>
...
export default function Example() {
  return (
    <Box marginBottom={2} display="flex" justifyContent="space-evenly" alignItems="center" padding={2} border="1px solid #ccc" borderRadius="4px">
      <SectionHeader
        overline={<Image src="https://cdn.watheia.org/assets/illustrations/rated-by-our-customer.png" alt="rating" style={{ width: 120, height: 'auto' }} width="auto" />}
        title="Rated 5 out of 5 stars by our customers!"
        subtitle="Companies from across the globe have had fantastic experiences using Watheia Labs. Here’s what they have to say."
        ctaGroup={[(
            <Button color="primary" variant="contained">Submit</Button>
        ), (
            <Button color="primary" variant="outlined">Learn More</Button>
        ...
        >
          <SectionHeader
            title={
              <>
                Find a job you love.
                <a href="https://thefront-v3.watheia.app/"> Learn more</a>
              </>
            }
            subtitle={
              <>
