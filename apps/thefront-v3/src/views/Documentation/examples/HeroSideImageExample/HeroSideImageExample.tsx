...
import { HeroSideImage } from "@watheia/front.organisms"
...
export default function Example() {
  return (
    <Box marginBottom={2} padding={2} border="1px solid #ccc" borderRadius="4px">
      <HeroSideImage imageSrc="https://cdn.watheia.org/assets/photos/expo-gallery/gallery1.jpg">
...
export default function Example() {
  return (
    <Box marginBottom={2} padding={2} border="1px solid #ccc" borderRadius="4px">
      <HeroSideImage imageSrc="https://cdn.watheia.org/assets/photos/expo-gallery/gallery2.jpg" reverse>
        <Grid container spacing={4}>
          <Grid item xs={12}>
  ...
  <div {...rest}>
    ...
    <SectionBox title="Reverse Order Example" gutterBottom>
      <>
        <Box marginBottom={2} padding={2} border="1px solid #ccc" borderRadius="4px">
          <HeroSideImage
            imageSrc="https://cdn.watheia.org/assets/photos/expo-gallery/gallery2.jpg"
            reverse
          >
            <Grid container spacing={4}>
              <Grid item xs={12}>
