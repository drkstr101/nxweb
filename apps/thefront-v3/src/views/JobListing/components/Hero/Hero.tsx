...
import { Image, Icon, IconText } from "@watheia/front.atoms"
        ...
        >
          <Grid item container alignItems="center" xs={12} md={6} data-aos={"fade-up"}>
            <SectionHeader
              ...
              subtitle="Productivity tools can either help you or get in the way. Watheia Labs aims to remove all barriers between you and just getting stuff done. "
              ctaGroup={[
          ...
          >
            <Image
              src="https://cdn.watheia.org/assets/illustrations/relax-working.svg"
              alt="Find a Job"
