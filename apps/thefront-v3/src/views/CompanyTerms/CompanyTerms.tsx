              ...
              <List className={classes.list}>
                <ListItem disableGutters>
                  ...
                  <Typography variant="body1" color="textPrimary">
                    ...
                    Paris, France, and is the parent company to all subsidiaries of
                    Material-UI Store.
                  </Typography>
                </ListItem>
                <ListItem disableGutters>
                ...
                <ListItem disableGutters>
                  ...
                  <Typography variant="body1" color="textPrimary">
                    ...
                    animations, films, videos, audiovisual works, or other media together
                    with all associated keywords, metadata, and/or titles.
                  </Typography>
                </ListItem>
                <ListItem disableGutters>
                  <ListItemAvatar>
