...
const Reviews = ({ data, className, ...rest }: ViewComponentProps): JSX.Element => {
  ...
  return (
    <div className={className} {...rest}>
      <SectionHeader
        title={
          <span className={classes.textWhite}>Take a look what our customers say</span>
        }
        subtitle={
          <span className={classes.textWhite}>
            Take a quick glance at some of our past projects. If you would like to see some
            more great work, get in touch with us to take a look at our private portfolio.
          </span>
        }
        align="left"
        data-aos="fade-up"
      />
      <div className={clsx("swiper-container", classes.swiperContainer)} data-aos="fade-up">
