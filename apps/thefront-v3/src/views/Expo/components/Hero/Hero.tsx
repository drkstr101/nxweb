...
const Hero = ({ className, ...rest }: ViewComponentProps): JSX.Element => {
  ...
  return (
    <div className={className} {...rest}>
      <HeroBackground backgroundImg="https://cdn.watheia.org/assets/photos/expo-gallery/gallery3@2x.jpg">
        <Grid container spacing={4}>
          <Grid item xs={12}>
            <Typography variant="h3" className={clsx(classes.textWhite, classes.title)}>
          ...
          <Grid item xs={12} md={6}>
            ...
            <Typography variant="h5" className={classes.textWhite}>
              ...
              team will be in touch to talk about your goals for Watheia Labs 2020.
            </Typography>
          </Grid>
          <Grid item xs={12} md={6}>
