...
const Courses = ({ data, className, ...rest }: ViewComponentProps): JSX.Element => {
                ...
                <Grid container spacing={1}>
                  ...
                  <Grid item container justify="space-between" xs={12}>
                    ...
                    <Grid item container alignItems="center" justify="flex-end" xs={6}>
                      <NoSsr>
                        <i className={clsx("fas fa-star", classes.courseCardReviewStar)} />
                      </NoSsr>
                      <Typography
                        component="span"
                        variant="body1"
                  ...
                  <Grid item xs={12}>
                    <LearnMoreLink title="Learn more" variant="body1" color="primary" />
                  </Grid>
                </Grid>
              }
            />
